...
import { createTuitionFee, getTuitionFeeByCourseId } from '@/services/tuitionFee';
import { checkAuth } from '@/utils/actions/session';

export const createTuitionFeeAction = async (data: any) => {
...
const handleCategoryCollege = async (data: any) => {
  return tryCatch(async () => {
    ...
    const createdDP = await createTuitionFee(dataToStore);
