  ...
  return (
    <Dialog>
      <DialogTrigger className='w-full rounded-none' asChild>
        <Button className='hover:bg-slate-300 w-full justify-start text-[16px] h-[60px] bg-slate-200 rounded-b-lg'>
          <div className='grid text-start '>
            <span className='font-semibold'>Birthday</span>
            <span className='text-muted-foreground text-sm'>20-20-2024</span>
          </div>
        </Button>
      </DialogTrigger>
      <Form {...form}>
        <DialogContent className='rounded-md max-w-[500px] bg-sky-50'>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
            <DialogHeader>
              ...
              <DialogTitle className='text-[22px] font-bold text tracking-normal'>Birthday</DialogTitle>
              <DialogDescription>
