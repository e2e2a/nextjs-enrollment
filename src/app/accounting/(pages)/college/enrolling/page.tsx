...
const Page = () => {
  ...
  useEffect(() => {
    ...
    if (data) {
      if (data.enrollment) {
        const filteredEnrollment = data?.enrollment?.filter((enrollment: any) => enrollment.enrollStatus === 'Pending' && enrollment.step === 5);
          ...
          {isError ? (
            ...
            <div className=''>
              <div className='mb-3 text-center w-full'>
                <h1 className='text-lg sm:text-2xl font-bold uppercase'>Enrolling Student Management</h1>
              </div>
