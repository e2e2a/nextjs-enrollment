          ...
          <div className='overflow-auto w-full bg-slate-50 rounded-lg'>
            <div className='grid sm:grid-cols-2 grid-cols-1 items-start w-full gap-y-1 mb-7'>
              ...
              <div className='flex w-full justify-start'>
                <span className='text-sm sm:text-[17px] font-bold capitalize'>
                  Verify By Registrar:
                  <span className='font-normal text-sm uppercase'> {reportGrades.statusInDean.toLowerCase() === 'pending' ? <span className=' text-green-500'>Verified</span> : <span className=' text-red'>Not Verified</span>}</span>
                </span>
              </div>
            </div>
            {reportGrades.statusInDean.toLowerCase() === 'pending' && (
