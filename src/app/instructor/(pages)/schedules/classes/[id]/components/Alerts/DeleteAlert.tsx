    ...
    <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
      <div className='flex justify-end '>
        <AlertDialogTrigger asChild>
          <Button type='button' disabled={isUploading} variant='outline' size={'sm'} className='focus-visible:ring-0 flex mb-2 bg-transparent bg-red px-2 py-0 gap-x-1 justify-center text-neutral-50 font-medium'>
            <div className=' text-white text-[15px] font-medium flex items-center gap-1'>
              {isUploading ? (
