...
import { useTeacherScheduleRecordByProfileIdQuery, useTeacherProfileQuery } from '@/lib/queries';
...
const Page = () => {
  ...
  const { data: pData, isLoading: pload, error } = useTeacherProfileQuery(s?.user.id as string);
