    ...
    if (sData?.length > 0 && sData) {
      ...
      c.curriculum.forEach((studentCurr: any) => {
        ...
        if (curriculumByYearAndSemester) {
          ...
          const studentSubjects = studentCurr.subjectsFormat.filter((subject: any) => !subject.grade || (subject.grade && (subject.grade.toLowerCase() === 'inc' || subject.grade === '0' || subject.grade === '5.0'))).map((s: any) => s);
