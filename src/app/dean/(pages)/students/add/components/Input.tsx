...
const Input = ({ name, type, form, label, classNameInput, isNotEditable }: IProps) => {
  return (
    <FormField
          ...
          <FormControl>
            <div className={`relative`}>
              <input
                type={type}
                id={name}
                className={`${classNameInput} block rounded-xl px-5 pb-2 pt-7 w-full text-sm bg-slate-50 border border-gray-200 appearance-nonefocus:outline-none focus:ring-0 focus:border-gray-400 peer pl-4 align-text-bottom`}
