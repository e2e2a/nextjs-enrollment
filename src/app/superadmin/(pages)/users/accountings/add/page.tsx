...
const Page = () => {
  ...
  const formProfile = useForm<z.infer<typeof AccountingProfileUpdateValidator>>({
  ...
  const onSubmit = async (e: any) => {
    ...
    const data = { ...userData, ...profileData, role: 'ACCOUNTING', configProfile: configProfile };
      ...
      <Card className='border-0 bg-transparent'>
        <CardHeader className='space-y-3'>
          ...
          <CardDescription className='text-xs sm:text-sm'>
            To register a new user admin, please provide the necessary information. This information is essential for administrative purposes and will help enable additional features in the system.
          </CardDescription>
        </CardHeader>
