...
export function ComboboxSubjects({ form, name, label, selectItems, placeholder }: IProps) {
              ...
              <div className='relative bg-slate-50 rounded-lg'>
                <Popover open={open} onOpenChange={setOpen}>
                  ...
                  <PopoverContent align='start' className=' p-0 bg-white w-full flex border-gray-300 '>
                    <Command className='w-full' value={field.value} defaultValue={field.value}>
                            ...
                            selectItems.map((item: any, index: any) => (
                              ...
                              >
                                ...
                                <div className='flex flex-col text-sm'>
                                  ...
                                  <span>Descriptive Title: {item.name}</span>
