    ...
    <div className='flex items-center justify-center h-screen bg-gray-100'>
      <div className='text-center'>
        <div className='flex items-center justify-center'>
          ...
          <Image src={'https://firebasestorage.googleapis.com/v0/b/my-project-eaeb4.appspot.com/o/logo%2Flogo1.png?alt=media&token=8ebc5ba9-67b3-47fa-ae2c-7cb1e7d9c76f'} alt='nothing to say' width={100} height={100} priority className='rounded-full ' />
        </div>
