    ...
    <div className='flex drop-shadow-none shadow-md shadow-orange-200 my-3 flex-col relative max-w-[69rem] w-full border border-gray-40 rounded-xl pt-5 pb-12 px-11 bg-white space-y-4'>
      ...
      <div className='flex-col'>
        <p className='text-muted-foreground text-justify text-sm sm:text-[15px]'>
          &nbsp;&nbsp;&nbsp;&nbsp;We’re thrilled to have you join us! To get started, we redirect you to your profile page where you can complete your profile details. This will help us tailor our services to your needs and ensure you have the best experience
          possible. If you have any questions or need assistance along the way, don’t hesitate to reach out to our{' '}
      ...
      <div className='flex-col'>
        ...
        <p className='text-muted-foreground text-justify'>
          &nbsp;&nbsp;&nbsp;&nbsp;To ensure a smooth and complete enrollment process, please be aware that you must fill out your profile before proceeding. You won&apos;t be able to navigate to other pages or access further enrollment steps until your profile
          is completed. This helps us provide you with the best experience possible and ensures all your information is accurately recorded. If you encounter any issues or have questions, our support team is here to help!
        </p>
      </div> */}
    </div>
