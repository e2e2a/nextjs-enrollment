  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      <Tabs defaultValue='profile' onValueChange={handleTabChange} className='w-full'>
        <div className='w-full justify-center items-center flex border-b-2 drop-shadow-md flex-col bg-gradient-to-t from-white from-20% via-blue-200 via-70% to-sky-300'>
        ...
        {isOpen && (
          ...
          <TabsContent value='profile' className={`w-full bg-white mb-3 max-w-[69rem] rounded-lg drop-shadow-sm shadow-sm ${isOpen ? 'mt-10' : ' mt-10'}  `}>
            <ProfileTab />
          </TabsContent>
