          ...
          <CardContent className='w-full border space-y-2 p-0 group-hover:bg-gray-300 group-hover:bg-opacity-55 group-hover:border-blue-200'>
            <div className='w-full flex sm:flex-row flex-col rounded-lg'>
              ...
              <div className='flex flex-col flex-1 p-5'>
                ...
                <div className='space-y-1.5 flex flex-col px-2'>
                  <p className='text-sm text-muted-foreground text-justify first-letter:uppercase'>
                    &nbsp;&nbsp;&nbsp;&nbsp;The Senior High School program at Dipolog City Institute of Technology, INC. offers students in Grades 11 and 12 an opportunity to deepen their academic knowledge and practical skills while preparing them for their
                    future endeavors. With a curriculum that includes various tracks—Academic, Technical-Vocational-Livelihood (TVL), and Sports—students can choose paths that align with their interests and career aspirations. The program emphasizes critical
                    thinking, problem-solving, and real-world applications, ensuring that graduates are well-equipped for higher education, employment, or entrepreneurship. At DCIT, INC., we foster an environment of innovation, collaboration, and excellence,
                    empowering students to achieve their goals and contribute positively to society.
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent className='w-full border space-y-2 p-0 group-hover:bg-gray-300 group-hover:bg-opacity-55 group-hover:border-blue-200'>
            <div className='w-full flex sm:flex-row flex-col rounded-lg'>
              ...
              <div className='flex flex-col flex-1 p-5'>
                <div className='flex w-full justify-end items-center hover:underline'>
                  <Link href={``} className='flex gap-2 items-center text-sm'>
                    <span className='text-blue-700'>View Courses</span> <Icons.arrowRight className='h-4 w-4' />
                  </Link>
                </div>
                ...
                <div className='space-y-1.5 flex flex-col px-2'>
                  <p className='text-sm text-muted-foreground text-justify first-letter:uppercase'>
                    ...
                    seeking to develop specific technical skills and competencies. This program caters to individuals who aspire to enter the workforce with practical expertise in various fields, including automotive technology, electronics, culinary arts, and
                    more. Our curriculum is designed to meet industry standards, ensuring that students are equipped with the knowledge and skills necessary for employment or entrepreneurship. With experienced instructors and modern facilities, DCIT, INC.
                    fosters a supportive learning environment that empowers students to achieve their career goals and succeed in their chosen vocations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card className='w-full group shadow-sm drop-shadow-sm bg-white'>
          ...
          <CardContent className='w-full border space-y-2 p-0 group-hover:bg-gray-300 group-hover:bg-opacity-55 group-hover:border-blue-200'>
            <div className='w-full flex sm:flex-row flex-col rounded-lg'>
              ...
              <div className='flex flex-col flex-1 p-5'>
                <div className='flex w-full justify-end items-center hover:underline'>
                  <Link href={`/courses/college`} className='flex gap-2 items-center text-sm'>
                    <span className='text-blue-700'>View Courses</span> <Icons.arrowRight className='h-4 w-4' />
                  </Link>
                </div>
                ...
                <div className='space-y-1.5 flex flex-col px-2'>
                  <p className='text-sm text-muted-foreground text-justify first-letter:uppercase'>
                    &nbsp;&nbsp;&nbsp;&nbsp;The College Program at Dipolog City Institute of Technology, INC. offers a comprehensive higher education experience designed to equip students with the knowledge, skills, and competencies needed to thrive in their
                    chosen fields. With a diverse array of degree programs in areas such as engineering, information technology, business administration, and hospitality management, students receive a well-rounded education that emphasizes both academic
                    excellence and practical application. Our dedicated faculty, modern facilities, and innovative teaching methods foster a dynamic learning environment where students are encouraged to engage, collaborate, and develop critical thinking
                    skills. At DCIT, INC., we prepare graduates not only for successful careers but also for lifelong learning and responsible citizenship in an ever-changing global landscape.
                  </p>
                </div>
              </div>
            </div>
