...
const FileTOR = ({ handleSelectedFileTOR, handleRemoveFileTOR, handleClickFileTOR, fileTORInputRef, fileTORPreview, fileTORError, isUploading }: IProps) => {
  return (
