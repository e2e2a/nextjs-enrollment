  ...
  return (
    <>
      {isPageLoading ? (
        ...
        <TabsContent value='3' className='p-5 focus-visible:ring-0 border-0'>
            ...
            <CardContent className='flex w-full justify-center flex-col items-center border-[0.5px] rounded-lg shadow-sm bg-white focus-visible:ring-0 space-y-5 px-0 mx-0'>
              <div className='w-full flex flex-col items-center justify-center h-full'>
                ...
                <span className='text-sm text-left mt-4 px-5 sm:px-10 w-full'>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is from the administrator of DCIT.You can now view your schedule, though it may be empty for now. As soon as your subjects are added, they will appear here. Feel free to check back regularly to see any
                  updates to your schedule. If you have any questions or need further assistance, please read our docs; documentation is available at{' '}
