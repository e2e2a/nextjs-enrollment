...
const FileGoodMoral = ({ handleSelectedFileGoodMoral, handleRemoveFileGoodMoral, handleClickFileGoodMoral, fileGoodMoralInputRef, fileGoodMoralPreview, fileGoodMoralError, isUploading }: IProps) => {
  return (
