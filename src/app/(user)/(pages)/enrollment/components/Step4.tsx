          ...
          <Card className={`min-h-[35vh] shadow-none drop-shadow-none items-center justify-center flex border-0`}>
            ...
            <CardContent className='flex w-full justify-center flex-col items-center border-[0.5px] rounded-lg shadow-sm bg-white focus-visible:ring-0 space-y-5 px-0 mx-0'>
              <div className='w-full flex flex-col items-center justify-center h-full'>
                ...
                <h1 className='text-center text-xl sm:text-3xl font-bold font-poppins text-green-400'>Add/Drop Subjects!</h1>
                ...
                <span className='text-sm text-left mt-4 px-5 sm:px-10 w-full'>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is from the administrator of DCIT. You can now review and adjust your schedule by adding or dropping subjects. The courses you are currently enrolled in are listed below, and any changes you make will be reflected here immediately. Make sure to review your schedule carefully before finalizing any changes. If you have any questions or need further assistance, please read our docs; documentation is available at{' '}
