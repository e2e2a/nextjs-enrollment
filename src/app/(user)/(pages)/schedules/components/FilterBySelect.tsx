...
const FilterBySelect = ({ studentBlockType, setStudentBlockType, studentYear, setStudentYear, schedules }: IProps) => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex md:flex-row flex-col gap-5'>
        ...
        {/* <div className='relative bg-slate-50 rounded-lg'>
          ...
          >
            <SelectTrigger id={'studentSemester'} className='w-44 uppercase pt-10 pb-4 text-left text-black rounded-lg focus:border-gray-400 ring-0 focus:ring-0 px-4'>
              <SelectValue placeholder={'Select Block Type'} />
            </SelectTrigger>
            <SelectContent className='bg-white border-gray-300'>
              <SelectGroup>
