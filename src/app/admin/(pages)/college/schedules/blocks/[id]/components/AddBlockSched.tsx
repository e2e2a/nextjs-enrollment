        ...
        <div className=''>
          {selectedItems.length > 0 && (
            <div className='flex justify-between'>
              ...
              <Button type='submit' className='bg-blue-600 text-neutral-50' size={'sm'} onClick={() => actionFormSubmit()} variant='secondary'>
                Save
              </Button>
            </div>
          )}
                      ...
                      <CommandItem className='border w-full block' key={s._id} value={s.subjectId.name}>
                        <div className='flex w-full'>
                          <div className='min-w-[80px] justify-center flex items-center'>
                            {isSelected(s._id) ? (
                              <Button onClick={() => handleSelect(s._id)} type='button' size={'sm'} className={'focus-visible:ring-0 flex mb-7 bg-transparent bg-red px-2 py-0 gap-x-0 sm:gap-x-1 justify-center  text-neutral-50 font-medium'}>
