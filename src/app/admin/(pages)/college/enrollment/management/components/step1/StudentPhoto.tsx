  ...
  const handleDownload = async () => {
    if (photoUrl) {
      try {
        ...
        link.href = url;
        link.setAttribute('download', `${user.profileId.firstname} ${user.profileId.middlename[0] + '.'} ${user.profileId.lastname} ${user.profileId.extenstionName ? user.profileId.extenstionName : ''}.png`);
