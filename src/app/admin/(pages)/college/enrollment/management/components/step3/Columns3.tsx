...
import ActionsCell3 from './ActionsCell';
...
export const columns2: ColumnDef<Enrollment>[] = [
  ...
  },
  {
    ...
    cell: ({ cell, row }) => {
      ...
      return (
        <div key={cell.id} className='capitalize'>
          {user.isStudentProfile ? <Badge className='bg-green-500 text-white'>Verified</Badge> : <Badge variant="destructive" className='text-white'>Not Verified</Badge>}
        </div>
      );
    },
  },
