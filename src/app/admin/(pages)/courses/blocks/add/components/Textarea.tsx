...
const TextareaField = ({ name, type, form, label, classNameInput }: IProps) => {
  return (
    <FormField
        ...
        <FormItem>
          <FormControl>
            <div className={`relative`}>
              ...
              >
               <span className='flex gap-x-1 select-none items-center'>{label}: <span className=' flex gap-0 text-xs w-full'> (optional) <span className="text-red">*</span></span></span>
              </label>
            </div>
          </FormControl>
