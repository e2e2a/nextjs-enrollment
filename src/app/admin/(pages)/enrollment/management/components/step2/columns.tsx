...
export const columns: ColumnDef<Enrollment>[] = [
  ...
  //                   <Link href={`/profile/${user.userId.username}`} disabled={isPending} className={'w-full rounded-md focus-visible:ring-0 flex mb-2 text-black bg-transparent hover:bg-blue-600 px-2 py-2 gap-x-1 justify-start  hover:text-neutral-50 '}>
  //                     <div className='flex justify-center items-center text-sm font-medium gap-x-1'>
  //                       <Icons.eye className='h-4 w-4' />
  //                       View student profile
  //                     </div>
  //                   </Link>
  //                   <Button disabled={isPending} size={'sm'} onClick={actionFormSubmit} className={'w-full focus-visible:ring-0 flex mb-2 text-black bg-transparent hover:bg-green-500 px-2 py-0 gap-x-1 justify-start hover:text-neutral-50 font-medium'}>
  //                     <Icons.check className='h-4 w-4' />
  //                     Make an appointment
  //                   </Button>
  //                   <Button disabled={isPending} type='submit' size={'sm'} className={'w-full focus-visible:ring-0 mb-2 text-black bg-transparent flex justify-start hover:bg-red px-2 py-0 gap-x-1 hover:text-neutral-50 font-medium'}>
