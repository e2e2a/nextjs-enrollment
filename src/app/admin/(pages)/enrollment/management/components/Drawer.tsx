...
import { EnrollmentApprovedStep1 } from '@/lib/validators/Validator';
...
export function DataTableDrawer({ user }: IProps) {
  ...
  const form = useForm<z.infer<typeof EnrollmentApprovedStep1>>({
    resolver: zodResolver(EnrollmentApprovedStep1),
    defaultValues: {
      studentType: data ? data: '',
      scholarType: '',
    },
  });
  const onSubmit = (data: z.infer<typeof EnrollmentApprovedStep1>) => {
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} onChange={(e) => {
                ...
                <div className='justify-center items-center flex-wrap'>
                  <div className='flex flex-col gap-4'>
                    ...
                    {/* <SelectInput label='Student year' form={form} name={'scholarType'} selectItems={selectType.scholarType} placeholder='Select scholar type' scholarType={isScholarType} asd={true} /> */}
                    {/* <SelectInput label='Student year' form={form} name={'studentType'} selectItems={selectType.studentType} placeholder='Select student type' setIsScholarType={setIsScholarType} asd={false} /> */}
                    <FormField
