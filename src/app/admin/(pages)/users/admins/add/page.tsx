...
import { AdminProfileValidator } from '@/lib/validators/AdminValidator';
...
const Page = () => {
  ...
  useEffect(() => {
    if (showProfile === 'Yes') {
      setTypeValidate(AdminProfileValidator);
      setDefaultValues({
        email: '',
        username: '',
        firstname: '',
    ...
    <div className='border py-5 bg-white rounded-xl'>
      <Card className='border-0 bg-transparent'>
        <CardHeader className='space-y-3'>
          <CardTitle className='text-left text-lg xs:text-2xl sm:text-3xl font-poppins'>Register a New Admin!</CardTitle>
          <CardDescription className='text-xs sm:text-sm'>To register a new user admin, please provide the necessary information. This information is essential for administrative purposes and will help enable additional features in the system.</CardDescription>
        </CardHeader>
        <Form {...formCollege}>
