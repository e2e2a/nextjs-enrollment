...
const EditStudentPhoto = ({ handleSelectedPhoto, handleRemovePhoto, handleClickPhoto, PhotoInputRef, photoPreview, photoError, isUploading }: IProps) => {
...
export default EditStudentPhoto;
